...
public class MyGdxGame extends Game {
	...
	public MyGdxGame(Database database) {
		...
		try {
			...
			firstOpen=true;
			MyGdxGame.database.insert_skin(0,"EE Mobile", 0, "cars/car.png", 1, "She is yours. Ride and don't die!");
			MyGdxGame.database.insert_skin(1,"EE Mobile", 500, "cars/ambulance.png", 0, "She rides it and it disgusting");
			MyGdxGame.database.insert_skin(2,"EE Mobile", 750, "cars/black_car.png", 0, "Black car whose owner is Russian ganster teacher");
			MyGdxGame.database.insert_skin(3,"EE Mobile", 999, "cars/mini_truck.png", 0, "A lot of money - a lot of dirt");
			MyGdxGame.database.insert_skin(4,"EE Mobile", 1250, "cars/mini_van.png", 0, "Mater Van");
			MyGdxGame.database.insert_skin(5,"EE Mobile", 1499, "cars/red_car.png", 0, "Red for head and heart");
			MyGdxGame.database.insert_skin(6,"EE Mobile", 2759, "cars/taxi.png", 0, "Become the best taxi in Russia");
